...
\restrict qrYwY5OzDNzrpsitfmydnOlJp4G61UifgIwj04IEMzO2rG9jdoSXm0r8OKErWmt
...
--
-- Data for Name: referral_transactions; Type: TABLE DATA; Schema: public; Owner: postgres
--
...
--
-- Name: course_resources course_resources_course_id_courses_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: courses courses_required_plan_id_subscription_plans_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: meetings meetings_course_id_courses_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: payments payments_plan_id_subscription_plans_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: payments payments_reviewed_by_users_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: progress progress_course_id_courses_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: progress progress_lesson_id_lessons_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: progress progress_user_id_users_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: referral_transactions referral_transactions_referred_user_id_users_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: referral_transactions referral_transactions_referrer_id_users_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: testimonials testimonials_user_id_users_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
\unrestrict qrYwY5OzDNzrpsitfmydnOlJp4G61UifgIwj04IEMzO2rG9jdoSXm0r8OKErWmt
